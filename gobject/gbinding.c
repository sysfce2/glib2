 ...
 * GBinding:
 *
 * A `GBinding` binds two object properties together.
 *
 ...
 * various ways of blocking a signal emission, like [function@GObject.signal_stop_emission]
 * or [function@GObject.signal_handler_block].
 *
