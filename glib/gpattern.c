 ...
 *
 * The [function@g_pattern_match_simple] and [method@GLib.PatternSpec.match] functions
 ...
 * instead of [function@g_pattern_match_simple]. This avoids the overhead of repeated
 * pattern compilation.
 */
