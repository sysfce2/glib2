 ...
 *
 * To create a new quark from a string, use [function@GLib.quark_from_string]
 * or [function@GLib.quark_from_static_string].
 *
 ...
 * is string interning, using [function@GLib.intern_string] or
 * [function@GLib.intern_static_string]. An interned string is a canonical
